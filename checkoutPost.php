...
if($noAdd) { //if the option to not save information to database is selected
    ...
    ?><script>alert('Payment has been completed! Payment information has not been saved.'); window.location.href='checkout.php'</script> <?php
    ...
    echo "Card Number: **** " . $rfourDigits . "<br>";
    echo "<form action='checkoutExisting.php' method='get'>";
    echo "<input type='text' name='existing' placeholder='6-Digit Pin'><br>";
